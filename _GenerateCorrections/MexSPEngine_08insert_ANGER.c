// mex MexSPEngine_08insert_ANGER.c COMPFLAGS="$COMPFLAGS -openmp"  LINKFALGS="$LINKFALGS -openmp"
// ez ugyan az mint a MexSPEngine_08insert.c csak ki van hagyva a Battacharia rész, ergo ez csak egy Anger képet ad.
