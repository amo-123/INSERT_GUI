...
void Run1Mcount(double *LRFpIJ, int Loop, double *PMTxy, int NumPMT, double SpectrumWindow, double *EC, double *UC, double *LinX, double *LinY, double PE, double BaseLine, double *PicOut, double *Count, double *CountEw, unsigned short *DataStream, int StreamDataLength, double *SPEC, double *SPECP) //NEW: SPEC and SPECP
{
        ...
        int nrhs, const mxArray *prhs[] )
{
    ...
    double *SPEC01, *SPEC02, *SPEC03, *SPEC04; //NEW
    double *SPECP01, *SPECP02, *SPECP03, *SPECP04; //NEW
    ...
    //NEW
    plhs[3] = mxCreateNumericMatrix(1, 50001, mxDOUBLE_CLASS, mxREAL);
    SPEC = mxGetPr(plhs[3]);
    SPEC01 = mxGetPr(mxCreateNumericMatrix(1, 50001, mxDOUBLE_CLASS, mxREAL));
    SPEC02 = mxGetPr(mxCreateNumericMatrix(1, 50001, mxDOUBLE_CLASS, mxREAL));
    SPEC03 = mxGetPr(mxCreateNumericMatrix(1, 50001, mxDOUBLE_CLASS, mxREAL));
    SPEC04 = mxGetPr(mxCreateNumericMatrix(1, 50001, mxDOUBLE_CLASS, mxREAL));
    
    plhs[4] = mxCreateNumericMatrix(1, 30001, mxDOUBLE_CLASS, mxREAL);
    SPECP = mxGetPr(plhs[4]);
    SPECP01 = mxGetPr(mxCreateNumericMatrix(1, 30001, mxDOUBLE_CLASS, mxREAL));
    SPECP02 = mxGetPr(mxCreateNumericMatrix(1, 30001, mxDOUBLE_CLASS, mxREAL));
    SPECP03 = mxGetPr(mxCreateNumericMatrix(1, 30001, mxDOUBLE_CLASS, mxREAL));
    SPECP04 = mxGetPr(mxCreateNumericMatrix(1, 30001, mxDOUBLE_CLASS, mxREAL));
    //NEW
    ...
    for (LoopM=0; LoopM<Loop; LoopM+=StreamDataLength*4){
        ...
        #pragma omp parallel sections shared(LRFpIJ, pFile, Loop, PMTxy, NumPMT, SpectrumWindow, EC, UC, LinX, LinY, PE, Count, CountEw, StreamDataLength)
        {
            ...
            #pragma omp section
            {
                ...
                Run1Mcount(LRFpIJ, Loop, PMTxy, NumPMT, SpectrumWindow, EC, UC, LinX, LinY, PE, BaseLine,  PicOut01, Count01, CountEw01, DataStream01, StreamDataLength, SPEC01, SPECP01); //NEW: SPEC and SPECP
            }
            #pragma omp section
            {
                ...
                Run1Mcount(LRFpIJ, Loop, PMTxy, NumPMT, SpectrumWindow, EC, UC, LinX, LinY, PE, BaseLine, PicOut02, Count02, CountEw02, DataStream02, StreamDataLength, SPEC02, SPECP02); //NEW: SPEC and SPECP
            }
            #pragma omp section
            {
                ...
                Run1Mcount(LRFpIJ, Loop, PMTxy, NumPMT, SpectrumWindow, EC, UC, LinX, LinY, PE, BaseLine, PicOut03, Count03, CountEw03, DataStream03, StreamDataLength, SPEC03, SPECP03); //NEW: SPEC and SPECP
            }
            #pragma omp section
            {
                ...
                Run1Mcount(LRFpIJ, Loop, PMTxy, NumPMT, SpectrumWindow, EC, UC, LinX, LinY, PE, BaseLine, PicOut04, Count04, CountEw04, DataStream04, StreamDataLength, SPEC04, SPECP04); //NEW: SPEC and SPECP
            }
    ...
    //NEW
    for(a=0;a<50001;a++)
        SPEC[a]=SPEC01[a]+SPEC02[a]+SPEC03[a]+SPEC04[a];
    
    for (b=0;b<30001;b++)
        SPECP[b]=SPECP01[b]+SPECP02[b]+SPECP03[b]+SPECP04[b];
    //NEW
